...
### Table Extraction
```bash
uv run ~/.claude/plugins/sql-lineage/skills/sql-lineage/scripts/extract_tables.py \
  "SQL_QUERY" [--names-only]
```

### Column Qualification
```bash
uv run ~/.claude/plugins/sql-lineage/skills/sql-lineage/scripts/qualify_columns.py \
